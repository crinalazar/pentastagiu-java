...
public class AirportMain {
    public static void main(String[] args) {
        ...
        Flight f1 = new Flight( "FL-654", "Paris", "10/02/2019 20:30", 8500, 35 );
        Flight f2 = new Flight( "FL-587", "Oslo", "22/01/2019 15:45", 9300, 40 );
        Flight f3 = new Flight( "FL-325", "Frankfurt", "26/01/2019 14:15", 7200, 55 );
...
//       System.out.println(f2.getFlightStatus());
      ///System.out.println(f3.getFlightStatus());
